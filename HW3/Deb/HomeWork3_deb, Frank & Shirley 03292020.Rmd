...
Model 1, Model 2 and Model 3 contain at least one highest score of each category. 
```{r, echo=TRUE, warning=FALSE}
data.frame(m1cM$byClass, 
                   m2cM$byClass, 
                   m3cM$byClass, 
                   m4cM$byClass,
                   m5cM$byClass,
...
# manipulate results DF
  ...
  dplyr::select(Model, Sensitivity, Specificity, Precision, Recall, F1) %>%
