...
As we see above, we have plotted `moneyball_test` which consists of kitchen_sink_error variable points.
...
As we see above, we have plotted `moneyball_test` which consists of simple_error variable points.
...
As we see above, we have plotted `moneyball_test` which consists of step_back_error variable points.
