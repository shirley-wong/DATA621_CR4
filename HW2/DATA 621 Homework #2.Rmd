...
#I changed the github link as I was gett the following message (Error in open.connection(con, "rb") : HTTP error 404.) with the following formula: data_raw <- read_csv('https://raw.githubusercontent.com/oggyluky11/DATA621_CR4/master/classification-output-data.csv') 
```
...
ROC(data_raw$class,data$scored.probability)
